...
// Updated to 2026 meta — sources: pokexperience.com, pokemongohub.net,
// switchbladegaming.com (see /js/constants.js comments)
...
const COUNTERS = [
  ...
  {name:'garchomp',         types:['dragon','ground'],   move:'ground'},
